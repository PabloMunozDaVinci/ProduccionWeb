          ...
          <div class="row">
            ...
            <div class="col-lg-3 order-2 order-lg-1">
              ...
              <div class="py-2 px-4 bg-dark text-white mb-3">
                <strong class="small text-uppercase fw-bold">Fashion &amp; Acc</strong>
              </div>
              ...
              <div class="py-2 px-4 bg-light mb-3">
                <strong class="small text-uppercase fw-bold">Health &amp; Beauty</strong>
              </div>
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                <li class="mb-2">
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="product text-center">
                    <div class="mb-3 position-relative">
                      ...
                      <a class="d-block" href="detail.php"><img class="img-fluid w-100" src="img/product-12.jpg" alt="..." /></a>
                    ...
                    <h6>
                      <a class="reset-anchor" href="detail.html">Black DSLR lense</a>
                    </h6>
