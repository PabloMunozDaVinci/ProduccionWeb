              ...
              <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0 px-xl-2">
                <div class="swiper product-slider-thumbs">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb.png" alt="..."></div>
                    <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_1.png" alt="..."></div>
                    <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_2.png" alt="..."></div>
                    <div class="swiper-slide h-auto swiper-thumb-item mb-3"><img class="w-100" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_3.png" alt="..."></div>
                  </div>
                </div>
              </div>
              <div class="col-sm-10 order-1 order-sm-2">
                <div class="swiper product-slider">
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide h-auto"><a class="glightbox product-view" href="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb.png" data-gallery="gallery2" data-glightbox="Product item 1"><img class="img-fluid" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb.png" alt="..."></a></div>
                    <div class="swiper-slide h-auto"><a class="glightbox product-view" href="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_1.png" data-gallery="gallery2" data-glightbox="Product item 2"><img class="img-fluid" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_1.png" alt="..."></a></div>
                    <div class="swiper-slide h-auto"><a class="glightbox product-view" href="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_2.png" data-gallery="gallery2" data-glightbox="Product item 3"><img class="img-fluid" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_2.png" alt="..."></a></div>
                    <div class="swiper-slide h-auto"><a class="glightbox product-view" href="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_3.png" data-gallery="gallery2" data-glightbox="Product item 4"><img class="img-fluid" src="/imagenes/productos/<?php echo $prod['id'] ?>/img_0_thumb_3.png" alt="..."></a></div>
                  </div>
                </div>
              </div>
            </div>
